...
DWGR.TFW8:NewPayload(GROUP:FindByName("F-4E Mk82"), 48, {AUFTRAG.Type.BAI, AUFTRAG.Type.CAS,AUFTRAG.Type.CASENHANCED,AUFTRAG.Type.ORBIT}, 80)
DWGR.TFW8:NewPayload(GROUP:FindByName("F-4E Mk82SNAKES"), 48, {AUFTRAG.Type.BAI, AUFTRAG.Type.CAS,AUFTRAG.Type.CASENHANCED,AUFTRAG.Type.ORBIT}, 80)
...
DWGR.TFW8:NewPayload(GROUP:FindByName("F-4E STRIKE1"), 2, { AUFTRAG.Type.CAS,AUFTRAG.Type.CASENHANCED,AUFTRAG.Type.ORBIT,AUFTRAG.Type.PATROLZONE}, 79)
DWGR.TFW8:NewPayload(GROUP:FindByName("F-4E STRIKE2"), 2, { AUFTRAG.Type.CAS,AUFTRAG.Type.CASENHANCED,AUFTRAG.Type.ORBIT,AUFTRAG.Type.PATROLZONE}, 60)
