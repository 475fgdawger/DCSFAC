...
DWGR.TFW8:NewPayload(GROUP:FindByName("F-4E Mk82"), 48, {AUFTRAG.Type.BAI, AUFTRAG.Type.CASENHANCED,AUFTRAG.Type.ORBIT}, 70)
DWGR.TFW8:NewPayload(GROUP:FindByName("F-4E Mk82SNAKES"), 48, {AUFTRAG.Type.BAI, AUFTRAG.Type.CASENHANCED,AUFTRAG.Type.ORBIT}, 80)
DWGR.TFW8:NewPayload(GROUP:FindByName("F-4E SEADMk22"), 4, {AUFTRAG.Type.SEAD}, 80)
DWGR.TFW8:NewPayload(GROUP:FindByName("F-4E SEADMix"), 4, {AUFTRAG.Type.SEAD}, 70)
DWGR.TFW8:NewPayload(GROUP:FindByName("F-4E STRIKE1"), 12, {AUFTRAG.Type.STRIKE }, 80)
DWGR.TFW8:NewPayload(GROUP:FindByName("F-4E STRIKE2"), 12, {AUFTRAG.Type.STRIKE}, 80)
DWGR.TFW8:NewPayload(GROUP:FindByName("F-4E STRIKE1"), 2, { AUFTRAG.Type.BAI,AUFTRAG.Type.CASENHANCED,AUFTRAG.Type.ORBIT,AUFTRAG.Type.PATROLZONE}, 79)
DWGR.TFW8:NewPayload(GROUP:FindByName("F-4E STRIKE2"), 2, { AUFTRAG.Type.BAI,AUFTRAG.Type.CASENHANCED,AUFTRAG.Type.ORBIT,AUFTRAG.Type.PATROLZONE}, 60)
DWGR.TFW8:NewPayload(GROUP:FindByName("F-4E Strafe"), 48, { AUFTRAG.Type.CASENHANCED,AUFTRAG.Type.ORBIT}, 80)
